...
// Ejemplo de un componente que utiliza un ícono de Font Awesome
export const WhatsAppIcon: React.FC<IconSvgProps> = ({
  size = 36, // Tamaño aumentado
  ...props
...
// Puedes mantener otros íconos SVG que no quieras cambiar aquí
...
export const SearchIcon = (props: IconSvgProps) => (
  <svg
    ...
    fill="none"
    focusable="false"
    height={36} // Tamaño aumentado
    role="presentation"
    viewBox="0 0 24 24"
    width={36} // Tamaño aumentado
    {...props}
  >
    <path
