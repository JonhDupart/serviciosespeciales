...
const animationVariants: Record<AnimationStyle, { initial: object; animate: object; exit: object }> = {
  "from-bottom": {
  ...
  return (
    <div className={cn("relative", className)}>
      <div
        ...
        role="button" // Añadir rol
        tabIndex={0} // Habilitar navegación por teclado
        onKeyPress={(e) => e.key === 'Enter' && setIsVideoOpen(true)} // Habilitar apertura por teclado
      >
        <Image
          src={thumbnailSrc}
          alt={thumbnailAlt}
          ...
          <div className="bg-slate-900/10 flex items-center justify-center rounded-full backdrop-blur-md size-28 dark:bg-slate-50/10">
            ...
            >
              <Play
                ...
                style={{
                  filter: "drop-shadow(0 4px 3px rgb(0 0 / 0.07))",
                }}
              />
            </div>
          </div>
          ...
          >
            ...
            >
              <motion.button
                ...
                onClick={() => setIsVideoOpen(false)}
                aria-label="Cerrar video" // Añadir accesibilidad
              >
              ...
              <div className="size-full border-2 border-white rounded-2xl overflow-hidden isolate z-[1] relative">
                <iframe
                  src={videoSrc}
                  title="Video demostrativo" // Título único
